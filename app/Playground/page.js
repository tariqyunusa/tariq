    ...
    return(
        <section className={styles.Playground__section}>
            <div className={styles.playground__text__wrapper}>
                <h1 className={styles.playground__main_header} data-animation = 'header'>Playground</h1>
                <h1 className={styles.playground__sub_header} data-animation = 'header'>A dump of cool things i've experimented with over the years. </h1>
            </div>
            <div className={styles.__dump}>
                {works.map((proj, i) => (
                    <div key={i} className={styles.work} data-animation = 'header'>
